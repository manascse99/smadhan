            ...
            {[1, 2, 3, 4].map((block, index) => (
              <div key={index} className="flex items-center">
                <div className="relative">
                  <div className="w-24 h-24 rounded-xl bg-gradient-hero shadow-glow flex items-center justify-center animate-pulse-slow">
                  ...
                  {/* Glow effect */}
                  <div className="absolute inset-0 rounded-xl bg-primary/20 blur-xl animate-glow" />
                </div>
                {index < 3 && (
                  <div className="hidden md:block w-16 h-1 bg-gradient-to-r from-primary to-secondary" />
                )}
              </div>
            ))}
          </div>
